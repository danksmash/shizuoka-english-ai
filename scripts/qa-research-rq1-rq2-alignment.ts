...
const rawSessions = [
  ...
  // A short/interrupted choice remains a valid RQ1 selection opportunity when the
  // final lesson-context decision says it was in class. It is not dialogue-analysis ready.
...
assert.ok(rq1Page.includes('実践校の担当国を取り込む'));
...
assert.ok(rq1Page.includes('画面上の位置・性別・イラスト'));
