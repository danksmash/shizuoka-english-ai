...
.recent-card .rsh-toolbar{display:flex;gap:7px;align-items:center;margin:-2px 0 9px}.recent-card .rsh-toolbar input{min-width:0;flex:1;padding:8px 9px;font-size:12px}.recent-card .rsh-toolbar button{white-space:nowrap;padding:8px 10px;font-size:11px}.recent-card .rsh-count{font-size:10px;color:#64748b;margin:0 0 6px}.recent-card .table-wrap{max-height:430px;overflow:auto}.analysis-session-layout .recent-card .table-wrap{flex:1;max-height:none;min-height:620px;overflow:auto}.recent-card .recent thead th{position:sticky;top:0;z-index:2;background:#f3f7fc}.recent-card .recent tbody tr[data-rsh-research]{cursor:pointer}.recent-card .recent tbody tr[data-rsh-research]:hover,.recent-card .recent tbody tr[data-rsh-research]:focus{background:#eef5ff;outline:none}
...
@media(max-width:1240px){.analysis-session-layout .recent-card .table-wrap{min-height:460px}}@media(max-width:760px){.analysis-session-layout .recent-card .table-wrap{min-height:360px}.rsh-panel{width:100vw}.rsh-detail-meta{grid-template-columns:1fr}.rsh-utterance{grid-template-columns:42px 40px minmax(0,1fr)}.rsh-modal-backdrop{padding:0}.rsh-modal{width:100vw;max-height:100vh;height:100vh;border-radius:0}.rsh-modal-tools{flex-direction:column;align-items:stretch}}
</style>`;
