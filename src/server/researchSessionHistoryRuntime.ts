...
@media(max-width:1240px){.analysis-session-layout .recent-card .table-wrap{min-height:380px;max-height:560px}}@media(max-width:760px){.analysis-session-layout .recent-card .table-wrap{min-height:320px;max-height:500px}.rsh-panel{width:100vw}.rsh-detail-meta{grid-template-columns:1fr}.rsh-utterance{grid-template-columns:max-content 40px minmax(0,1fr);column-gap:8px}.rsh-modal-backdrop{padding:0}.rsh-modal{width:100vw;max-height:100vh;height:100vh;border-radius:0}.rsh-modal-tools{flex-direction:column;align-items:stretch}}
</style>`;
